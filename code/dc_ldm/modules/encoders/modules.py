...
from transformers import CLIPTokenizer, CLIPTextModel, AutoProcessor, CLIPVisionModel, CLIPVisionModelWithProjection, CLIPTextModelWithProjection
...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77):
        ...
        self.device = device
        self.transformer = CLIPTextModelWithProjection.from_pretrained(version).to(self.device) #CLIPTextModel
        self.max_length = max_length
        self.freeze()
    ...
    def forward(self, text):
        ...
        z = outputs.text_embeds #last_hidden_state
        return z
